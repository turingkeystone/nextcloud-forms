...
file2.txt"
	...
	public static function dataValidateSubmission() {
		return [
			...
			'required-video-not-uploaded' => [
				[
					['id' => 1, 'type' => Constants::ANSWER_TYPE_VIDEO, 'text' => 'Video', 'isRequired' => true]
				],
				[],
				'Question "Video" is required.',
			],
			'required-video-missing-upload-token' => [
				[
					['id' => 1, 'type' => Constants::ANSWER_TYPE_VIDEO, 'text' => 'Video', 'isRequired' => true]
				],
				[
			...
			'more-than-one-video' => [
				[
					[
						'id' => 1,
						'type' => Constants::ANSWER_TYPE_VIDEO,
						'text' => 'q1',
						'isRequired' => false,
						'extraSettings' => [],
					],
				...
				[
					'1' => [
						['uploadedFileId' => 1, 'uploadToken' => 'one'],
						['uploadedFileId' => 2, 'uploadToken' => 'two'],
					],
				],
				'Video question "q1" can only have one answer.',
			],
			'option-not-known' => [
				// Questions
				[
