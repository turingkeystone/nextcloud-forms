	...
	public static function dataAreExtraSettingsValid() {
		return [
			...
			'valid-video-settings' => [
				'extraSettings' => [
					'allowedResolutions' => ['720p', '1080p', '2160p'],
					'allowExistingVideo' => true,
			...
			'invalid-video-resolution' => [
				'extraSettings' => ['allowedResolutions' => ['1080p', '8k']],
				'questionType' => Constants::ANSWER_TYPE_VIDEO,
				'expected' => false,
			],
			'invalid-video-duplicate-resolution' => [
				'extraSettings' => ['allowedResolutions' => ['1080p', '1080p']],
				'questionType' => Constants::ANSWER_TYPE_VIDEO,
				'expected' => false,
			],
			'invalid-video-resolution-element-type' => [
				'extraSettings' => ['allowedResolutions' => ['1080p', ['2160p']]],
				'questionType' => Constants::ANSWER_TYPE_VIDEO,
				'expected' => false,
			],
			'invalid-video-default-not-allowed' => [
				'extraSettings' => [
			...
			'invalid-video-duration' => [
				'extraSettings' => ['maxRecordingDurationSeconds' => 7201],
				'questionType' => Constants::ANSWER_TYPE_VIDEO,
				'expected' => false,
			],
			'invalid-video-orientation' => [
				'extraSettings' => ['recordingOrientation' => 'square'],
				'questionType' => Constants::ANSWER_TYPE_VIDEO,
				'expected' => false,
			],
		];
