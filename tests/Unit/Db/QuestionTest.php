...
class QuestionTest extends TestCase {
	...
	public function testIsEmailTypeStatic(string $type, array $extraSettings, bool $expected): void {
		$this->assertSame($expected, Question::checkEmailType($type, $extraSettings));
	}
	...
	public function testVideoAllowExistingFalseIsPreserved(): void {
		$question = new Question();
		$question->setExtraSettings([
			'allowExistingVideo' => false,
			'shuffleOptions' => false,
		]);

		$this->assertSame(['allowExistingVideo' => false], $question->getExtraSettings());
	}
}
