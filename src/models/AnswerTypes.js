...
import QuestionVideo from '../components/Questions/QuestionVideo.vue'
...
export default {
	...
	video: {
		component: markRaw(QuestionVideo),
		icon: IconVideo,
		label: t('forms', 'Video recording'),
		predefined: false,

		titlePlaceholder: t('forms', 'Video recording question title'),
		warningInvalid: t('forms', 'This question needs a title!'),
	},
