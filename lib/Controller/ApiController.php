...
class ApiController extends OCSController {
	...
	public function deleteQuestion(int $formId, int $questionId): DataResponse {
		...
		if (in_array($question->getType(), [Constants::ANSWER_TYPE_FILE, Constants::ANSWER_TYPE_VIDEO], true)) {
	...
	private function storeAnswersForQuestion(Form $form, $submissionId, array $question, array $answerArray): void {
		...
		foreach ($answerArray as $answer) {
			...
			} elseif (in_array($question['type'], [Constants::ANSWER_TYPE_FILE, Constants::ANSWER_TYPE_VIDEO], true)) {
