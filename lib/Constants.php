...
class Constants {
	...
	public const VIDEO_MAX_RECORDING_DURATION_SECONDS = 2 * 60 * 60;
	...
	public const EXTRA_SETTINGS_VIDEO = [
		'allowedResolutions' => ['array'],
		'allowExistingVideo' => ['boolean'],
		'defaultResolution' => ['string'],
		'maxRecordingDurationSeconds' => ['integer'],
