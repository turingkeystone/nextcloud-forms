...
This private fork adds high-quality mobile video questions and a derived Nextcloud
AIO image. See [the AIO image deployment guide](container/README.md) for the
offline-runtime and manual-upgrade workflow.
...
- See [Video recording questions](docs/VideoRecording.md) for browser support, upload storage, deployment limits, and antivirus policy.
