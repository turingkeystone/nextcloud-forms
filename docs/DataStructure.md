...
| `video`           | One browser-recorded or device-selected video, with a configurable orientation requirement, chunked upload, and result playback                                                   |
...
| `allowedResolutions`          | `video`                                        | Array of strings | `720p, 1080p, 1440p, 2160p`                 | Resolutions the respondent's active camera may use                          |
| `allowExistingVideo`          | `video`                                        | Boolean          | `true/false`                                | Allow selecting a device video instead of recording                         |
| `defaultResolution`           | `video`                                        | String           | `720p, 1080p, 1440p, 2160p`                 | Preferred resolution, default: `1080p`                                      |
| `maxRecordingDurationSeconds` | `video`                                        | Integer          | `60..7200`                                  | Maximum recording duration, default: `7200`                                 |
| `recordingOrientation`        | `video`                                        | String           | `landscape, portrait, any`                  | Required recording orientation, default: `landscape`                        |
